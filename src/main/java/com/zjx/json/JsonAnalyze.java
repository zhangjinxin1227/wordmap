...
public  List<Zsd>  parseListzsd(String str){
		
		List<Zsd> zsdList = null;
		try {
			 zsdList =  
				    objectMapper.readValue(str, new TypeReference<List<Zsd>>(){});
		} catch (Exception e) {
			// TODO: handle exception
			return null;
		}
