...
public class HttpClientUtil {
    ...
    public static final String CONNECTION_ERRO = "通讯失败";
    ...
    public static String sendGetRequest(String reqURL, String encodeCharset, Integer timeout) {
        ...
        String respContent = "{\"resCode\":\"7777\",\"resMsg\":\"通信失败\"}";
        ...
        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(timeout).setConnectTimeout(10000).build();// 设置请求和传输超时时间（版本>=4.3设置超时方式）
            ...
            try {
                ...
                if (null != entity) {
                    ...
                    try {
                        ...
                        if(null != respContent){
                            if (respContent.contains("<html>")) {
                                respContent = "{\"resCode\":\"9998\",\"resMsg\":\"系统错误，错误页面\"}";
                            }else if(respContent.equals("")){
                                respContent = "{\"resCode\":\"9997\",\"resMsg\":\"系统错误，空字符\"}";
                            }
                        }
                ...
                // System.out.println("请求地址：" + reqURL); update by baicun 20191010 日志脱敏
